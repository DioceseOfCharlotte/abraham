...
<div class="comment-author layout__item md-3-24">
	...
	<?php wp_reset_postdata(); ?>
			...
			<div class="card__phone-list layout__item">
				<?php foreach ( $phone_entries as $key => $phone_entry ) { ?>
					<div class="card__phone">
						<i class="fa <?php echo $phone_entries [$key]['phone_type_select']; ?>"></i>
						<a href="tel:<?php echo $phone_entries [$key]['emp_phone']; ?>"><?php echo $phone_entries [$key]['emp_phone']; ?></a>
					</div>
				<?php } ?>
			</div>
		...
		<?php if($emp_emails){
			foreach ( $emp_emails as $email ) { ?>
				<div class="cardemail"><i class="fa fa-envelope"></i>
