...
if ( !class_exists( 'Diocese' ) ) {
	...
	class Diocese {
		...
		function extensions() {
			...
			if ( current_theme_supports( 'diocese-documents' ) ) {
				require_once( trailingslashit( DIOCESE_POSTS ) . 'departments.php' );
				require_once( trailingslashit( DIOCESE_META ) . 'document-meta.php' );
			}
