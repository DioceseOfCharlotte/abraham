...
final class Abraham_Custom_Styles {
	...
	public function get_primary_styles() {
		...
		$textC = $primaryColor->isDark() ? "fff" : "000";
		...
		$style .= "#page .u-bg-1-light{background-color:#{$color400}}";
		$style .= "#page .u-bg-1-dark{background-color:#{$color600}}";
		$style .= "#page .u-bg-1-glass{background-color:rgba( {$glass}, 0.9 )}";
		$style .= "#page .u-bg-1-glass-light{background-color:rgba( {$glass_light}, 0.9 )}";
		$style .= "#page .u-bg-1-glass-dark{background-color:rgba( {$glass_dark}, 0.9 )}";
