...
function abraham_customize_register( $wp_customize ) {
  ...
  /* Load JavaScript files. */
	add_action( 'customize_preview_init', 'abraham_customize_scripts' );
 ...
 */
function abraham_customize_scripts() {
  
	$suffix = hybrid_get_min_suffix();
	
	wp_enqueue_script( 'abraham-customize', trailingslashit( get_template_directory_uri() ) . "js/customizer{$suffix}.js", array( 'customize-preview' ), null, true );
}
