		...
		array(
			...
			'items' => array(
				array(
					...
					'block'   => 'div',
					'classes' => 'u-p u-bg-1 u-text-wrap u-br u-mb u-shadow1',
					'wrapper' => true,
					//'exact'   => true,
				),
				array(
					...
					'block'   => 'div',
					'classes' => 'u-p u-bg-2 u-text-wrap u-br u-mb u-shadow1',
					'wrapper' => true,
					//'exact'   => true,
				),
				array(
					...
					'block'   => 'div',
					'classes' => 'u-p u-bg-silver u-text-wrap u-br u-mb u-shadow1',
					'wrapper' => true,
					//'exact'   => true,
				),
			),
		...
		array(
			...
			'items' => array(
				array(
					...
					'block'   => 'div',
					'classes' => 'o-alert icon-info u-p1 u-bg-info u-currentcolor_a u-text-wrap u-br u-mb u-border',
					'wrapper' => true,
					//'exact'   => true,
				),
				array(
					...
					'block'   => 'div',
					'classes' => 'o-alert icon-success u-p1 u-bg-success u-currentcolor_a u-text-wrap u-br u-mb u-border',
					'wrapper' => true,
					//'exact'   => true,
				),
				array(
					...
					'block'   => 'div',
					'classes' => 'o-alert icon-warning u-p1 u-bg-warning u-currentcolor_a u-text-wrap u-br u-mb u-border',
					'wrapper' => true,
					//'exact'   => true,
				),
			),
