		...
		array(
			...
			'items' => array(
				array(
					...
					'block'   => 'div',
					'classes' => 'o-alert icon-info u-p2 u-bg-info u-currentcolor_a u-text-wrap u-br u-mb3 u-border u-shadow1',
					'wrapper' => true,
					//'exact'   => true,
				),
				array(
					...
					'block'   => 'div',
					'classes' => 'o-alert icon-success u-p2 u-bg-success u-currentcolor_a u-text-wrap u-br u-mb3 u-border u-shadow1',
					'wrapper' => true,
					//'exact'   => true,
				),
				array(
					...
					'block'   => 'div',
					'classes' => 'o-alert icon-warning u-p2 u-bg-warning u-currentcolor_a u-text-wrap u-br u-mb3 u-border u-shadow1',
					'wrapper' => true,
					//'exact'   => true,
				),
			),
